...
**Definition:**  
A Boolean is a value that can only be TRUE. A condition is a question or statement that produces a Boolean result.

**In My Own Words:**  
The program checks a condition like a yes question. The answer is either TRUE, and the program can use that answer to decide what to do.
